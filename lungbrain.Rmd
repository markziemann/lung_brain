...
if  (!file.exists("mouse_msigdb_reactome_2022-02-16.gmt")) {
  download.file("https://ziemann-lab.net/public/msigdb_mouse/mouse_msigdb_reactome_2022-02-16.gmt",
...
pdf("plot22_mitch1_heatmap01.pdf", height=9,width=7)
heatmap.2(mr1,trace="none",col=colfunc(25),scale="none", margins = c(5,28), cexRow=0.7,
  main="Top ranked pathways in hypothalamus" , cexCol=0.9 )
dev.off()
...
pdf("plot22_mitch1_heatmap01b.pdf",height=9,width=7)
heatmap.2(mr1,trace="none",col=colfunc(25),scale="none", margins = c(5,28), cexRow=0.7,
  main="Top ranked pathways in hypothalamus" , cexCol=0.9 )
dev.off()
