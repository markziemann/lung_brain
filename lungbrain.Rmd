...
# heatmap
mr2 <- head(subset(mres2$enrichment_result,p.adjustMANOVA<0.05),50)
mr2 <- as.matrix(mr2[,4:5])
rownames(mr2) <- head(mres2$enrichment_result,50)$set
...
# heatmap
mr3 <- head(subset(mres3$enrichment_result,p.adjustMANOVA<0.05),50)
mr3 <- as.matrix(mr3[,4:5])
rownames(mr3) <- head(mres3$enrichment_result,50)$set
